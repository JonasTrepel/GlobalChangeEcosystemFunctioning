...
Since we are not the owner of the data (and files exceed storage capacity of most providers), we provide all analysis ready datasets at OSF to ensure scripts in the analysis and viz folders can be reproduced: https://osf.io/zn8kg/files/osfstorage 
