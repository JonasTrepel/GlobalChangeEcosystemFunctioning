...
fwrite(dt_plot, "builds/model_estimates/greenup_functional_biomes_sep.csv")
...
p_est <- dt_plot %>%
  ...
  labs(title = "", y = NULL, x = "Vegetation Green-Up Trend Estimate", color = "Significance") +
  theme_minimal() +
  theme(legend.position = "none", 
...
ggsave(plot = p_est, "builds/plots/supplement/greenup_in_functional_biomes.png", dpi = 600, height = 10, width = 10)
