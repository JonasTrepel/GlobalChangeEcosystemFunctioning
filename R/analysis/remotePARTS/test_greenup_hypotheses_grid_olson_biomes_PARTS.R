...
fwrite(dt_plot, "builds/model_estimates/greenup_olson_biomes_sep.csv")
...
ggsave(plot = p_est, "builds/plots/supplement/greenup_in_olson_biomes.png", dpi = 600, height = 10, width = 10)
