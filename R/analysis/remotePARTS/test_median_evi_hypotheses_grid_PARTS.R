...
dt_median_evi <- dt %>%
  dplyr::select(all_of(median_evi_cols), functional_biome, X, Y, lon, lat, unique_id, 
...
fwrite(dt_median_evi %>% dplyr::select(
  unique_id, median_evi_coef, abs_median_evi_coef, median_evi_p_value), "data/processedData/dataFragments/grid_median_evi_trends.csv")
...
ggsave(plot = p_median_evi_a, "builds/plots/median_evi_remotePARTS_grid.png", dpi = 600, height = 3, width = 12)
...
p_cold_tall <- biome_gls(super_b = "cold_tall", fit_n = 15000, part_size = 1500,
                         col_pattern = "median_evi_", dat = dt, part = TRUE, start = list(range = 0.1))
...
p_median_evi_super_b <- gridExtra::grid.arrange(p_cold_tall, p_cold_short, p_not_cold_tall, p_not_cold_short,
                                         ncol = 4)
ggsave(plot = p_median_evi_super_b, "builds/plots/median_evi_remotePARTS_super_b_grid.png", dpi = 600, height = 3, width = 12)

p_median_evi <- gridExtra::grid.arrange(p_median_evi_a, p_median_evi_super_b, ncol = 1)
ggsave(plot = p_median_evi, "builds/plots/median_evi_remotePARTS_full_grid.png", dpi = 600, height = 5, width = 14)
...
fwrite(dt_est, "builds/model_estimates/median_evi_grid_estimates.csv")
