...
set.seed(161)
gls_h4.1 <- fitGLS_partition(abs_greenup_coef ~ 0 +
                               protection_cat_broad,
                             partmat = pm,
                             covar_FUN = "covar_exp",
                             covar.pars = list(range = range_opt_greenup),
...
# change --- 
gls_h5 <- fitGLS_partition(greenup_coef ~ 1 +
                             area_km2_log + 
                             pa_age_log,
                           partmat = pm_pa,
                           covar_FUN = "covar_exp",
...
gls_h5.1 <- fitGLS_partition(abs_greenup_coef ~ 1 +
                               area_km2_log + 
                               pa_age_log,
                             partmat = pm_pa,
                             covar_FUN = "covar_exp",
...
ggsave(plot = p_greenup_a, "builds/plots/greenup_remotePARTS_grid.png", dpi = 600, height = 3, width = 12)
...
p_greenup_super_b <- gridExtra::grid.arrange(p_cold_tall, p_cold_short, p_not_cold_tall, p_not_cold_short,
                                                 ncol = 4)
ggsave(plot = p_greenup_super_b, "builds/plots/greenup_remotePARTS_super_b_grid.png", dpi = 600, height = 3, width = 12)

p_greenup <- gridExtra::grid.arrange(p_greenup_a, p_greenup_super_b, ncol = 1)
ggsave(plot = p_greenup, "builds/plots/greenup_remotePARTS_full_grid.png", dpi = 600, height = 5, width = 14)
...
fwrite(dt_est, "builds/model_estimates/greenup_grid_estimates.csv")
