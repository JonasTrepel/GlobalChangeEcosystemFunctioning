...
fwrite(dt_mean_evi %>% dplyr::select(
  unique_id, mean_evi_coef, abs_mean_evi_coef, mean_evi_p_value), "data/processedData/dataFragments/grid_mean_evi_trends.csv")
...
gls_h1 # yes. Est: 5.402579  ; SE: 0.460251  ; pval.t: 8.304875e-32
...
ggsave(plot = p_mean_evi_a, "builds/plots/mean_evi_remotePARTS_grid.png", dpi = 600, height = 3, width = 12)
...
p_mean_evi_super_b <- gridExtra::grid.arrange(p_cold_tall, p_cold_short, p_not_cold_tall, p_not_cold_short,
                                         ncol = 4)
ggsave(plot = p_mean_evi_super_b, "builds/plots/mean_evi_remotePARTS_super_b_grid.png", dpi = 600, height = 3, width = 12)

p_mean_evi <- gridExtra::grid.arrange(p_mean_evi_a, p_mean_evi_super_b, ncol = 1)
ggsave(plot = p_mean_evi, "builds/plots/mean_evi_remotePARTS_full_grid.png", dpi = 600, height = 5, width = 14)
...
fwrite(dt_est, "builds/model_estimates/mean_evi_grid_estimates.csv")
