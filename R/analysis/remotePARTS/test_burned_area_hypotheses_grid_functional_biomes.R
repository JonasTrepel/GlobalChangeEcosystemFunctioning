...
fwrite(dt_plot, "builds/model_estimates/burned_area_functional_biomes_sep.csv")
...
p_est <- dt_plot %>%
  ...
  labs(title = "", y = NULL, x = "Burned Area Trend Estimate", color = "Significance") +
  theme_minimal() +
  theme(legend.position = "none", 
...
ggsave(plot = p_est, "builds/plots/supplement/burned_area_in_functional_biomes.png", dpi = 600, height = 10, width = 10)
