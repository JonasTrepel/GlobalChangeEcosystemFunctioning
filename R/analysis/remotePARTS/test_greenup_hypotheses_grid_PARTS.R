...
fwrite(dt_greenup %>% dplyr::select(
  unique_id, greenup_coef, abs_greenup_coef, greenup_p_value), "data/processedData/dataFragments/grid_greenup_trends.csv")
...
gls_h1 # no Est: -0.01840379 ; SE: 0.05771796  ; pval.t: 0.7498352
