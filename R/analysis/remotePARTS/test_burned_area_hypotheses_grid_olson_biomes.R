...
fwrite(dt_plot, "builds/model_estimates/burned_area_olson_biomes_sep.csv")
...
ggsave(plot = p_est, "builds/plots/supplement/burned_area_in_olson_biomes.png", dpi = 600, height = 10, width = 10)
