...
fwrite(dt_plot, "builds/model_estimates/zhu_n_depo_mean_evi_functional_biomes_sep.csv")
...
ggsave(plot = p_est, "builds/plots/supplement/zhu_n_depo_mean_evi_in_functional_biomes.png", dpi = 600, height = 10, width = 10)
